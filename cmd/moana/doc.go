...
// run.go defines [runUsage] for consistent stderr copy; run_test.go covers dispatch edge cases (unknown subcommand, user without subcommand, extra args after serve).
package main
