...
import {
  ...
  CATEGORY_MODAL_CLOSE_ELEMENT_ID,
  CATEGORY_MODAL_CLOSE_SELECTOR,
  ...
  SETTINGS_ADD_MEMBER_CLOSE_ELEMENT_ID,
...
describe('domSelectors category modal chrome', () => {
  it('builds #id selectors for dialog, form, and fields', () => {
    ...
    expect(CATEGORY_MODAL_CLOSE_SELECTOR).toBe(`#${CATEGORY_MODAL_CLOSE_ELEMENT_ID}`)
  })

  it('lists close for native dialog dismiss', () => {
    expect(CATEGORY_MODAL_DISMISS_SELECTORS).toEqual([CATEGORY_MODAL_CLOSE_SELECTOR])
  })
})
...
describe('domSelectors settings add-member', () => {
  ...
  it('builds close and cancel selectors for dialog dismiss', () => {
    expect(SETTINGS_ADD_MEMBER_CLOSE_SELECTOR).toBe(`#${SETTINGS_ADD_MEMBER_CLOSE_ELEMENT_ID}`)
    expect(SETTINGS_ADD_MEMBER_CANCEL_SELECTOR).toBe(`#${SETTINGS_ADD_MEMBER_CANCEL_ELEMENT_ID}`)
  })

  it('orders close then cancel for attachNativeDialogDismiss', () => {
    expect(SETTINGS_ADD_MEMBER_DISMISS_SELECTORS).toEqual([
      SETTINGS_ADD_MEMBER_CLOSE_SELECTOR,
      SETTINGS_ADD_MEMBER_CANCEL_SELECTOR,
    ])
  })
