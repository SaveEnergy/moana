 ...
 * Each no-ops when its DOM is missing. Documented in `design.md`; expected `function.name` order lives in `bootInitializerNames.ts` (asserted by `bootInitializers.test.ts`).
 */
