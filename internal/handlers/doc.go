...
// routes_settings.go, routes_notifications.go (GET /notifications loads [App.Notifications] + notifications.html). Form field names for login/settings: formnames.go. Auth/session: [App.CurrentUser], [App.WithAuth]. Rendering: layout.go,
