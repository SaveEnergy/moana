...
func registerLedgerRoutes(mux *http.ServeMux, app *App) {
	...
	mux.Handle(http.MethodGet+" "+TransactionEditPathPattern, app.WithAuth(app.TransactionEdit))
	mux.Handle(http.MethodPost+" "+TransactionPathPattern, app.WithAuth(app.TransactionUpdate))
