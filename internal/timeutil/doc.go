...
// YYYY-MM-DD parsing and [LoadLocation] (caches successful IANA zone lookups; concurrent misses coalesce) in range.go (see range_test.go); local calendar date keys in local_date_key.go.
