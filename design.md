...
- **Mobile drawer (≤1023px):** Open via `#app-sidebar-toggle`; close via toggle, **Escape**, or **delegated `click` on `#app-shell`** (backdrop `#app-sidebar-backdrop` or `#app-sidebar-close`).
