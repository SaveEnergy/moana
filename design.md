...
Documentation grounded in `frontend/src/app.css`, `frontend/src/styles/*.css`, `frontend/src/lib/*.ts`, `frontend/src/boot.ts`, `frontend/src/bootInitializers.ts`, `internal/assets/templates/`, and `frontend/src/main.ts`.
