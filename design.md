...
**Tokens:** `--semantic-positive`, `--semantic-negative`, `--semantic-negative-muted` live in **`01-tokens.css`**; dashboard and history surfaces use them instead of repeating hex literals.
